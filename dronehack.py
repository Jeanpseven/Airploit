...
photo_button = tk.Button(window, text="Tirar Foto", command=take_photo)
photo_button.pack()

start_rec_button = tk.Button(window, text="Iniciar Gravação", command=start_recording)
start_rec_button.pack()

stop_rec_button = tk.Button(window, text="Parar Gravação", command=stop_recording)
...
# Funções do segundo código (Conexão e controle do drone)
